...
<body>
    ...
    <section id="hero">
        <div class="container h-100">
            ...
            <img src="<?php echo e(asset('images/Hero Image.png')); ?>" alt="" class="position-absolute bottom-0 end-0 img-hero">
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-md-4">
                    <div class="card-layanan text-center">
                        <div class="circle-logo position-relative mx-auto">
                            <img src="<?php echo e(asset('images/Icon-propertybaru.png')); ?>" alt=""
                ...
                <div class="col-md-4">
                    <div class="card-layanan text-center">
                        <div class="circle-logo position-relative mx-auto">
                            <img src="<?php echo e(asset('images/Icon Sewa.png')); ?>" alt=""
                                class="position-absolute top-50 start-50 translate-middle">
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card-layanan text-center">
                        <div class="circle-logo position-relative mx-auto">
                            <img src="<?php echo e(asset('images/Icon Beli.png')); ?>" alt=""
                                class="position-absolute top-50 start-50 translate-middle">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="kontak">
                            ...
                            <div class="mb-3 d-flex align-items-center">
                                <img src="<?php echo e(asset('images/alamat.png')); ?>" alt="">
                                <a href="#">Jalan Pantai Rejo No. 24,
                                    Kelurahan Lateng,
                                    Kabupaten Banyuwangi</a>
                            </div>
                            <div class="mb-3">
                                <img src="<?php echo e(asset('images/telepon.png')); ?>" alt="">
                                <a href="#">+62 811-3331-1156</a>
                            </div>
                            <div class="mb-3">
                                <img src="<?php echo e(asset('images/Email Icon.png')); ?>" alt="">
                        ...
                        <a href="#" class="me-3">
                            <img src="<?php echo e(asset('images/Twiter Icon.png')); ?>">
                        </a>
                        <a href="#" class="me-3">
                            <img src="<?php echo e(asset('images/Instagram Iicon.png')); ?>">
                        </a>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\companyProfile\resources\views/home.blade.php ENDPATH**/ ?>